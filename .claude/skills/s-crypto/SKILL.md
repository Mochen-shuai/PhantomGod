---
name: s-crypto
description: Unified Cryptography Attacks skill linking hack-skills methodology with AboutSecurity execution resources.
---

# Unified Cryptography Attacks

## When To Use

Use for CTF and practical cryptography attack methodology.
...
- `../../security-sources/hack-skills/skills/hash-attack-techniques/SKILL.md` — SKILL: Hash Attack Techniques — Expert Cryptanalysis Playbook
- `../../security-sources/hack-skills/skills/rsa-attack-techniques/SKILL.md` — SKILL: RSA Attack Techniques — Expert Cryptanalysis Playbook
...
- `../../security-sources/hack-skills/skills/active-directory-kerberos-attacks/SKILL.md` — SKILL: Kerberos Attack Playbook — Expert AD Attack Guide

## Matched AboutSecurity Skills

- `../../security-sources/AboutSecurity/skills/ctf/ctf-crypto/SKILL.md` — CTF 密码学攻击
- `../../security-sources/AboutSecurity/skills/exploit/advanced/crypto-web-attack/SKILL.md` — Web 密码学攻击方法论
- `../../security-sources/AboutSecurity/skills/tool/hashcat-crack/SKILL.md` — hashcat 密码哈希离线破解
- `../../security-sources/AboutSecurity/skills/exploit/web-method/php-type-juggling/SKILL.md` — PHP Type Juggling 攻击方法论
- `../../security-sources/AboutSecurity/skills/mobile/ios-pentesting/SKILL.md` — iOS 应用渗透测试方法论

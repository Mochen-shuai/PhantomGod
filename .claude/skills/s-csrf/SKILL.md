---
name: s-csrf
description: Unified Cross-Site Request Forgery skill linking hack-skills methodology with AboutSecurity execution resources.
---

# Unified Cross-Site Request Forgery

## When To Use

Use for CSRF testing, anti-CSRF defense bypass, SameSite analysis, JSON CSRF, login CSRF, and OAuth state manipulation.
...
- `../../security-sources/hack-skills/skills/csrf-cross-site-request-forgery/SKILL.md` — CSRF testing playbook: state-changing web flows, anti-CSRF defenses, SameSite behavior, JSON CSRF, login CSRF, OAuth state handling
- `../../security-sources/hack-skills/skills/business-logic-vulnerabilities/SKILL.md` — Business Logic Vulnerabilities (CSRF chaining)

## Matched AboutSecurity Skills

- `../../security-sources/AboutSecurity/skills/exploit/auth/csrf-methodology/SKILL.md` — CSRF 跨站请求伪造检测与利用

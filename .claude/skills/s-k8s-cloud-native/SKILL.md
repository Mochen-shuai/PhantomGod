---
name: s-k8s-cloud-native
description: Unified Kubernetes and Cloud Native Security skill linking hack-skills methodology with AboutSecurity execution resources.
---

# Unified Kubernetes and Cloud Native Security

## When To Use

Use for Kubernetes, container, ingress, admission webhook, sidecar and cloud-native security assessment.

## Source Priority

| Task Type | Primary Source |
|---|---|
| Methodology | AboutSecurity |
...
- `../../security-sources/hack-skills/skills/kubernetes-pentesting/SKILL.md` — SKILL: Kubernetes Pentesting — Expert Attack Playbook
- `../../security-sources/hack-skills/skills/cmdi-command-injection/SKILL.md` — SKILL: OS Command Injection — Expert Attack Playbook
- `../../security-sources/hack-skills/skills/container-escape-techniques/SKILL.md` — SKILL: Container Escape Techniques — Expert Attack Playbook
...
- `../../security-sources/AboutSecurity/skills/cloud/k8s-webhook-abuse/SKILL.md` — Kubernetes Admission Webhook 滥用
- `../../security-sources/AboutSecurity/skills/cloud/k8s-ingress-nightmare/SKILL.md` — IngressNightmare — CVE-2025-1974
- `../../security-sources/AboutSecurity/skills/cloud/k8s-sidecar-attack/SKILL.md` — Kubernetes Sidecar 流量劫持
- `../../security-sources/AboutSecurity/skills/cloud/k8s-container-escape/SKILL.md` — Kubernetes 容器逃逸与集群攻击
- `../../security-sources/AboutSecurity/skills/tool/k8spider/SKILL.md` — K8Spider — Kubernetes DNS 服务发现

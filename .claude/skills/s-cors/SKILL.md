---
name: s-cors
description: Unified Cross-Origin Resource Sharing misconfiguration skill linking hack-skills methodology with AboutSecurity execution resources.
---

# Unified CORS Misconfiguration

## When To Use

Use for CORS misconfiguration testing, origin reflection analysis, credentialed cross-origin access, preflight bypass, and browser-based API data theft.
...
- `../../security-sources/hack-skills/skills/cors-cross-origin-misconfiguration/SKILL.md` — CORS misconfiguration: origin reflection, credentialed browser reads, preflight bypass, browser-based access to authenticated APIs

## Matched AboutSecurity Skills

- `../../security-sources/AboutSecurity/skills/exploit/auth/cors-misconfiguration/SKILL.md` — CORS 跨域配置错误检测与利用
...
- `../../security-sources/AboutSecurity/Payload/cors/cors.md`
